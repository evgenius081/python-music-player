...
class Controls(QWidget):
    ...
    def __create_buttons(self):
        ...
        self.__shuffle_button = QPushButton(QIcon("common/assets/shuffle_inactive.svg"), "")
        ...
        self.__cycle_button = QPushButton(QIcon("common/assets/cycle.svg"), "")
    ...
    def __create_sound_controls_widget(self):
        ...
        self.__sound_icon = QSvgWidget("common/assets/sound.svg")
    ...
    def __set_prev_button_disabled(self):
        ...
        self.__play_prev_button.setIcon(QIcon("common/assets/play_prev_inactive.svg"))

    def __set_prev_button_active(self):
        self.__play_prev_button.setDisabled(False)
        self.__play_prev_button.setIcon(QIcon("common/assets/play_prev_active.svg"))

    def __set_next_button_disabled(self):
        self.__play_next_button.setDisabled(True)
        self.__play_next_button.setIcon(QIcon("common/assets/play_next_inactive.svg"))

    def __set_next_button_active(self):
        self.__play_next_button.setDisabled(False)
        self.__play_next_button.setIcon(QIcon("common/assets/play_next_active.svg"))
    ...
    def __shuffling_changed(self):
        if self.__media_player.get_shuffled():
            self.__shuffle_button.setIcon(QIcon("common/assets/shuffle_active.svg"))
        else:
